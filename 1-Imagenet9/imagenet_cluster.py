...
from dataset_imagenet import get_imagenet_dataloader
...
parser.add_argument('--cluster_dir', type=str, default='pre_cluster_results')
...
def main(n_try=None):
    ...
    data_loader = get_imagenet_dataloader(root='/disk2/wangtan/dataset/ImageNet/imagenet/ILSVRC/Data/CLS-LOC/train', batch_size=args.batch_size, train=False)

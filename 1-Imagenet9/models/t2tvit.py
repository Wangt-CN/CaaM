...
@register_model
def T2t_vit_12_feature(pretrained=False, **kwargs): # adopt performer for tokens to token
    model = T2T_ViT_Feature(tokens_type='performer', embed_dim=256, depth=12, num_heads=4, mlp_ratio=2., **kwargs)
    model.default_cfg = default_cfgs['T2t_vit_12']
    return model
